...
const app = {
  ...
  songs: [
    ...
    {
      name: "Ban Tinh Oi",
      singer: "YuniBooGoctoiMixer",
      path: "./music/BanTinhOi-YuniBooGoctoiMixer-6137656.mp3",
    ...
    {
      name: "Duyen Ta Troi Lay",
      singer: "Anh Khoa Cover",
      // path: "https://mp3.vlcmusic.com/download.php?track_id=14448&format=320",
      path: "./music/DuyenTaTroiLay-AnhKhoaCover-7156773.mp3",
      image:
    ...
    },
    {
      name: "final_music ",
      singer: "hen_yeu",
      path: "./music/final_music_hen_yeu.mp3",
    ...
    },
    {
      ...
      path: "./music/SeeTinh-HoangThuyLinh-7195809.mp33",
      // path: "https://mp3.filmisongs.com/go.php?id=Damn%20Song%20Raftaar%20Ft%20KrSNa.mp3",
      image:
        "https://filmisongs.xyz/wp-content/uploads/2020/07/Damn-Song-Raftaar-KrNa.jpg"
    },
    {
      name: "Duyen No Vo Chong",
      singer: "Di lan Vu",
      path: "./music/DuyenNoVoChong-DilanVu-7183184.mp3",
